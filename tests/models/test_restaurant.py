...
class TestRestaurant(unittest.TestCase):
    ...
    def test_long_name(self):
        ...
        with self.assertRaises(ValueError):
            restaurant = self.restaurant.Restaurant(long_name, 10, 20, 55555555, 'Vegetarian')

    def test_short_name(self):
        short_name = ""
        with self.assertRaises(ValueError):
            restaurant = self.restaurant.Restaurant(short_name, 10, 20, 55555555, 'Vegetarian')

    def test_too_high_lat1(self):
        lat = 1000
        with self.assertRaises(ValueError):
            restaurant = self.restaurant.Restaurant("name", lat, 20, 55555555, 'Vegetarian')
    ...
    def test_too_high_lon1(self):
        lon = 1000
        with self.assertRaises(ValueError):
            restaurant = self.restaurant.Restaurant("name", 10, lon, 55555555, 'Vegetarian')
    ...
    def test_too_high_phone1(self):
        phone = 99999999999
        with self.assertRaises(ValueError):
            restaurant = self.restaurant.Restaurant("name", 10, 10, phone, 'Vegetarian')
    ...
    def test_long_menu_type(self):
        long_name = """AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
            ...
            AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"""
        with self.assertRaises(ValueError):
            restaurant = self.restaurant.Restaurant("name", 10, 20, 55555555, long_name)

    def test_short_menu_type(self):
        short_name = ""
        with self.assertRaises(ValueError):
            restaurant = self.restaurant.Restaurant("name", 10, 20, 55555555, short_name)
